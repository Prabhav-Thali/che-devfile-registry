...
while read -r line; do
  ...
  echo "Updating devfiles using 'quay.io/prabhav/$image_name:nightly' to '$REGISTRY/$ORGANIZATION/$image_name:$TAG'"
  sed -i "s|quay.io/prabhav/$image_name:nightly|$REGISTRY/$ORGANIZATION/$image_name:$TAG|g" "${devfiles[@]}"
